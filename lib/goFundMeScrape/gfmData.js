...
const count = animals.push({ animal: 'cows' });
console.log(count);
// expected output: 4
console.log(animals);
...
// const titleObject = combinedArray2[0].map((x) => {
//   emptyThing1.push({ campaign_name: x });
// });

const totalObject = combinedArray2[0].map((x) => {
  emptyThing1.push({
    campaign_name: x,
    current_amount: null,
    goal: null,
...
const urlObject = () => {
  combinedArray2[1].map((x) => {
    return (emptyThing1[0].link_url = x);
  });
};
...
// const urlObject = combinedArray2[1].map((x) => {
//   emptyThing1.replace({ link_url: x });
// });
...
// const obj = Object.fromEntries(mapThing);
// console.log(obj);

// const urlObject = combinedArray2[1].map((x) => {
//   emptyThing2.push({ link_url: x });
// });
...
// for (const key of emptyThing1) {
//      obj[key] = whatever;
// }

// console.log(Object.values(emptyThing1[0]));
// console.log(emptyThing2);
